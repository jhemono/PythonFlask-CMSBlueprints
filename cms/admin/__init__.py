...
def edit(id):
    ...
    if request.method == "POST":
        ...
        flash(error)
    return render_template('admin/content_form.html', title="Edit", types=types, type_name=type.name, item_title=content.title, slug=content.slug, type_id=content.type_id, body=content.body)
